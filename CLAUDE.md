...
This project is indexed by GitNexus as **higgs-nightly** (6041 symbols, 15794 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/higgs-nightly/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/higgs-nightly/context` | Codebase overview, check index freshness |
| `gitnexus://repo/higgs-nightly/clusters` | All functional areas |
| `gitnexus://repo/higgs-nightly/processes` | All execution flows |
| `gitnexus://repo/higgs-nightly/process/{name}` | Step-by-step execution trace |
